...
being ridden based on an input parameter, fastest. 
...
# My first thought was whenever we are looking for maximum, We need to sort it
# [5,5,3,9,2] => [9,5,5,3,2]
# [3,6,7,2,1] => [7,6,3,2,1]
# Breakdown: I need to redo this question
...
print(tandemBicycle([3, 9, 2], [7, 2, 1], False))